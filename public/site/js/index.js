...
function getContentTab(url,selector){
	...
	var loading = '<div class="a-center"><img src="//bizweb.dktcdn.net/100/490/431/themes/927074/assets/rolling.svg?1758009136246" alt="loading"/></div>';
	$.ajax({
		type: 'GET',
		url: url,
		beforeSend: function() {
				...
				$(selector + ' .add_to_cart').click(function(e){
					...
					$.ajax({
						...
						success: function(line_item) {
							...
							ajaxCart.load();
							$('.cart-sidebars, .backdrop__body-backdrop___1rvky').addClass('active');
						},
						cache: false
					});
				});
...
function getContentTab2(url,selector){
	...
	var loading = '<div class="row"><div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null"><div class="item_product_main"></div></div><div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null"><div class="item_product_main"></div></div><div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null"><div class="item_product_main"></div></div><div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null"><div class="item_product_main"></div></div><div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null hidden-md"><div class="item_product_main"></div></div><div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null hidden-md"><div class="item_product_main"></div></div></div>';
	$.ajax({
		type: 'GET',
		url: url,
		beforeSend: function() {
