...
@section('content')
    ...
    @if ($categorySpecialPostNumber1)
        <section class="section-index section_blog">
            <div class="container">
                <div class="section-title side-left has-control">
                    <h2>
                        <a href="{{ route('front.list-blog', $categorySpecialPostNumber1->slug) }}"
                            title="{{ $categorySpecialPostNumber1->name }}">
                            {{ $categorySpecialPostNumber1->name }}
                        </a>
                    </h2>
                    <div class="swiper-button-prev"></div>
                    <div class="swiper-button-next"></div>
                ...
                <div class="blog_swiper swiper-container control-top">
                    <div class="swiper-wrapper">
                        @foreach ($categorySpecialPostNumber1->posts as $post)
                            <div class="swiper-slide">
                                <div class="item-blog">
    ...
    {{-- @if ($categorySpecialFlashsale)
        <section class="section-index section_product section_product_1 section_flash_sale" style="background-color: #f9f9f9; padding: 30px 0;">
            <div class="container">
                <div class="row">
    ...
    {{-- @foreach ($categorySpecial as $category)
        <section class="section-index section_product section_product_1" style="padding: 30px 0;">
            <div class="container">
                <div class="row">
                    <div class="block-title col-sm-12 col-xs-12 col-lg-3 col-xl-2">
                        <div class="section-title side-left has-control">
        ...
        @if ($category->products->count() > 0)
            ...
            @if ($category->banner)
                <section class="section-index section_big_banner">
                    <div class="container">
                        <a href="{{ route('front.show-product-category', $category->slug) }}"
                            title="{{ $category->name }}" class="big-banner">
                            <picture>
                                <source media="(max-width: 480px)"
                                    srcset="{{ $category->banner ? $category->banner->path : 'https://placehold.co/1780x385' }}">
                                <img data-src="{{ $category->banner ? $category->banner->path : 'https://placehold.co/1780x385' }}"
