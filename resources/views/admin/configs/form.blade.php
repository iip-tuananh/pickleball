	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-8 col-xs-12">
                ...
                <div class="form-group custom-group">
                    <label class="form-label">Địa chỉ công ty (cơ sở 4)</label>
                    <input class="form-control" ng-model="form.address_company_4" type="text">
                </div>
                <div class="form-group custom-group">
                    <label class="form-label">Địa chỉ công ty (cơ sở 5)</label>
                    <input class="form-control" ng-model="form.address_company_5" type="text">
                </div>
                <div class="form-group custom-group">
                    <label class="form-label">Địa chỉ công ty (cơ sở 6)</label>
                    <input class="form-control" ng-model="form.address_company_6" type="text">
                </div>
                <div class="form-group custom-group">
