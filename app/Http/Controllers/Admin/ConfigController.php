...
class ConfigController extends Controller
{
	...
	public function update(Request $request)
	{
		...
		try {
			...
			$object->address_company_4 = $request->address_company_4;
			$object->address_company_5 = $request->address_company_5;
			$object->address_company_6 = $request->address_company_6;
